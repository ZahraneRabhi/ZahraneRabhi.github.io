...
export class ProjectDetailsComponent implements OnInit {
  ...
  // Projects data matching exactly from projects.component.ts
  projects: any[] = [
    {
      id: 'Wakalny',
      name: 'Wakalny',
    ...
    },
    {
      ...
      screenshots: ['/assets/projects/ng-github-stats/screenshots/image.png'],
  ...
  goToNextScreenshot(): void {
    if (this.project?.screenshots && this.project.screenshots.length > 0) {
      this.activeScreenshotIndex =
        (this.activeScreenshotIndex + 1) % this.project.screenshots.length;
    }
  }
